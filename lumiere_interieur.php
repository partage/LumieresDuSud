...
$sel = mysql_query("SELECT id, nom
					FROM albums_lumiere_interieure
					ORDER BY nom ASC");
...
$tab_photos 		= glob("images/Center/Middle/Porfolio/Lumiere_int/$album_actuel/*.jpg");
$tab_photos_small 	= glob("images/Center/Middle/Porfolio/Lumiere_int/$album_actuel/small/*.jpg");
$tab_photos_zoom 	= glob("images/Center/Middle/Porfolio/Lumiere_int/$album_actuel/zoom/*.jpg");
...
$commentaires = file("images/Center/Middle/Porfolio/Lumiere_int/$album_actuel/commentaires.txt");
...
HTML;
                ...
                <div class="Container_Middle_Menu">
                	<ul>
                        ...
                        <li><span class="Container_Middle_Menu_ok">Lumière d'intérieur</span></li>
                	...
                	<div class="container_SousMenu_Liens_Imgs">
                    	<ul>
                        	...
                        	foreach($tab_albums as $id => $nom) {
                        		...
                        		echo '<li><a href="lumiere_interieur.php?album='.$id.'">&raquo; '.$nom.'</a></li>';
                        	}
